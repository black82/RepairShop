...
export class ClouseOrderFormComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.editDisable = this.typePage === 'edit';
  ...
  createClient() {
    ...
    this.client = new Client(null, formData.family, formData.name, formData.companyName, formData.email,
      ...
      null);
    this.preOrderShop = new PreOrderShop(this.preorders.preOrderShop.orderId,
  ...
  submitFormAndSendEmail() {
    this.titleForm = 'Close Order Invoice';
